...
const dropdowns = {
  "About Us": [
    ...
    { name: "V.P & Director IQAC Message", link: "/about/vice-principal" },
    { name: "Dean's(SSW) Message", link: "/about/dean-message" },
    { name: "Dean's(R&D) Message", link: "/about/dean" },
     { name: "Dean's(Academic) Message", link: "/about/dean-academic" },
