      ...
      <div className="uf-container">
        ...
        <div className="uf-bottom">
          <div className="uf-address">
            ...
            <p className="uf-address-text">
              Phone: 022 - 28461891 / 022 - 67308000, 67308106 / 07 | Fax: 022 - 28461890
            </p>
            <p className="uf-address-text">
              E-Mail:{" "}
            ...
            <p className="uf-address-text">
              Websites:{" "}
              <a className="uf-link" href="http://www.tcetmumbai.in">www.tcetmumbai.in</a>,{" "}
              <a className="uf-link" href="http://www.thakureducation.org">www.thakureducation.org</a>
            </p>
          </div>
